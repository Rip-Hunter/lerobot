...
# Added for logging using tensorboard #
...
def log_train_info(
    ...
    if tensorboard_writer is not None:
        tensorboard_writer.add_scalar("train/loss", loss, step)
        tensorboard_writer.add_scalar("train/grad_norm", grad_norm, step)
        tensorboard_writer.add_scalar("train/lr", lr, step)
        tensorboard_writer.add_scalar("train/update_time_s", update_s, step)
        tensorboard_writer.add_scalar("train/dataloading_time_s", dataloading_s, step)
        tensorboard_writer.add_scalar("train/num_samples", num_samples, step)
        tensorboard_writer.add_scalar("train/num_episodes", num_episodes, step)
        tensorboard_writer.add_scalar("train/num_epochs", num_epochs, step)
...
def log_eval_info(logger, info, step, cfg, dataset, is_online):
    ...
    if tensorboard_writer is not None:
        tensorboard_writer.add_scalar("eval/avg_sum_reward", avg_sum_reward, step)
        tensorboard_writer.add_scalar("eval/pc_success", pc_success, step)
        tensorboard_writer.add_scalar("eval/eval_time_s", eval_s, step)
        tensorboard_writer.add_scalar("eval/num_samples", num_samples, step)
        tensorboard_writer.add_scalar("eval/num_episodes", num_episodes, step)
        tensorboard_writer.add_scalar("eval/num_epochs", num_epochs, step)
...
def train(cfg: TrainPipelineConfig):
    ...
    ##############################################
    tensorboard_writer = SummaryWriter(log_dir=str(cfg.output_dir / "tensorboard"))
    ##############################################
